    ...
    return  (
        <>
            <div style={{ padding: 30 }}>
                ...
                <p>E-commerce is revolutionizing the way we all shop in India. Why do you want to hop from one store to another in search of the latest phone when you can find it on the Internet in a single click? Not only mobiles. aayakart houses everything you can possibly imagine, from trending electronics like laptops, tablets, smartphones, and mobile accessories to in-vogue fashion staples like shoes, clothing and lifestyle accessories; from modern furniture like sofa sets, dining tables, and wardrobes to appliances that make your life easy like washing machines, TVs, ACs, mixer grinder juicers and other time-saving kitchen and small appliances; from home furnishings like cushion covers, mattresses and bedsheets to toys and musical instruments, we got them all covered. You name it, and you can stay assured about finding them all here. For those of you with erratic working hours, aayakart is your best bet. Shop in your PJs, at night or in the wee hours of the morning. This e-commerce never shuts down.</p>
                    ...
                    <div className="second_class">
                        <div className="container second_class_bdr">
                            <div className="row" style={{margin:0}}>
                                <div className="col-md-4 col-sm-6">
                                    <div className="footer-logo"><img  style={{ height: 60, width: 200 }} alt="logo" />
                                    </div>
                    ...
                    <div className="row" style={{margin:0}}>
                        <div className="container-fluid">
                            <div className="seller">
                                <a href='#' style={{ color: "white" }}> <IoBagHandleSharp style={{ height: 20, width: 20, color: "yellow" }} />  Become a Seller  </a>
                            </div>
                            <div className="Help">
                                <a href='#' style={{ color: "white" }}> <AiFillQuestionCircle style={{ height: 20, width: 20, color: "yellow" }} /> Help</a></div>
                            <div className="" ><a href='#' style={{ color: "white" }}>  &copy;2020 - 2022 Aayakart</a></div>
                            <div className="cardpayement">
                                <img src='https://static-assets-web.flixcart.com/www/linchpin/fk-cp-zion/img/payment-method_69e7ec.svg' className='cardimg'></img>
                            </div>
